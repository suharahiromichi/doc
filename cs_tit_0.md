...
provT(x)はΣ1文であるので、(式2.13)を適用できる。

```T ⊢ provT(⌜GT⌝) ⇐ T ⊢ GT```         ..... (式2.13)を左辺に適用する、無矛盾な拡大のとき

```T ⊢ provT(⌜GT⌝) ⇔ T ⊢ GT```         ..... (式2.13')を左辺に適用する、1-無矛盾な拡大のとき


- 以上より、TがQの無矛盾な拡大なら、
``T ⊢ GT ⇔ T ⊢ provT(⌜GT⌝) ⇒ T ⊢ ~GT``
となって、GTが導けるとすると~GTが導けてしまうので、GTが導けないことが結論できる。
``T ⊬ GT`` である。

- さらに、TがQの1-無矛盾な拡大なら、
``T ⊢ GT ⇔ T ⊢ provT(⌜GT⌝) ⇔ T ⊢ ~GT``
となって、GTが導けるとすると~GTが導けてしまい、
~GTが導けるとするとGTが導けてしまうので、~GTもGTも導けないことが結論できる。
``T ⊬ GT /\ T ⊬ ~GT`` である。

...
また、定理27よりProvTはΣ1集合である。
逆像を考えると、補題11より``fA_-1(ProvT)``もΣ1集合である。
...
Π1集合とΣ1集合が等しくなり(Π1⊆Σ1 かつ Σ1⊆Π1)、算術階層の厳密性に反する。
すなわち、TはΠ1完全ではない。
...
無矛盾性と健全性の関係より、TはQのΣ1健全なREなら、TはQの無矛盾なREなので、
...
無矛盾性と健全性の関係より、Tが健全なら、TはΣ1健全なので、
